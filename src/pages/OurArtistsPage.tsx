        ...
        <div className="container px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
            {Object.values(artists).map(artist => (
              <Link
                to={`/artist/${artist.craftTypeName}/${artist.slug}`}
                key={artist.id}
              ...
              >
                ...
                {artist.craftScore !== undefined && artist.craftScore !== null && artist.craftScore !== 0 && (
                  <div className="flex flex-col items-center justify-center mt-1 w-full">
                    ...
                    <div className="flex justify-center w-full">
                      <ScoreRing score={Math.trunc(artist.craftScore)} />
                    </div>
                  </div>
                )}
              </Link>
