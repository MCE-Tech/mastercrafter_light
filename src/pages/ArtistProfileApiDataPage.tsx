...
import StickyArtistDataHeader from "../components/StickyArtistDataHeader";
import ArtistIntroAPIData from "../components/ArtistIntroAPIData";
import { useArtistData } from "../hooks/useArtistData";
import { useShowStickyHeader } from "../hooks/useShowStickyHeader";
import ArtistFlipAPICard from "@/components/ArtistFlipAPICard";
...
export default function ArtistProfileApiDataPage() {
    const {  artist, isLoading , artistDetails} = useArtistData();

    if (typeof window !== "undefined") {
        // eslint-disable-next-line no-console
        console.debug("[ArtistProfileApiDataPage] mount - artist=", artist ? artist.slug : null);
    }
    ...
    return (
        <div className="relative min-h-screen">
            <AnimatedBackground />
            <StickyArtistDataHeader artist={artist} isVisible={showSticky} artistDetails={artistDetails} />
            ...
            <section className="py-12 md:py-16 lg:py-20 relative z-10">
                <div className="container px-2 md:px-4 max-w-6xl mx-auto">
                    ...
                    >
                        <ArtistIntroAPIData artist={artist} artistDetails={artistDetails} />
                        <ArtistFlipAPICard
                            artist={artist}
