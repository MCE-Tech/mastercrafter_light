...
export default function ArtistProfilePage() {
  ...
  <div className="container px-2 md:px-4 max-w-6xl mx-auto">
          <div ref={heroRef} className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start mb-10 text-center md:text-left">
            <div className="col-span-1 flex flex-col items-center md:items-start">
              <img
                src={artist.image}
                alt={artist.name}
                className="w-44 h-44 object-cover rounded-full mb-4 border-4 border-primary/30"
              />
              <h1 className="text-4xl font-extrabold mb-2 gradient-text">{artist.name}</h1>
            ...
            <div className="col-span-2">
              ...
              <div className="w-full mt-6 rounded-xl bg-white/80 shadow p-6 border-l-4 border-primary">
          ...
          <div className="max-w-6xl mx-auto px-2 md:px-0 mt-8">
            <div className="mb-4">
