...
export function ClientsHero() {
  return (
    <section className="relative overflow-hidden py-20 md:py-24 lg:py-28">
      ...
      {/* Decorative elements */}
      <div className="absolute top-20 left-10 w-20 h-20 rounded-full bg-secondary/20 blur-xl" />
      <div className="absolute bottom-20 right-10 w-32 h-32 rounded-full bg-primary/20 blur-xl" />
      ...
      <div className="container relative z-10">
        <div className="flex flex-col items-center text-center space-y-6 max-w-4xl mx-auto">
          ...
          <h2 className="text-2xl md:text-3xl font-bold">Services for Clients</h2>
        </div>
      </div>
